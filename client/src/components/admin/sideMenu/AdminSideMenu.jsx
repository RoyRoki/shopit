...
import { faBox, faChartSimple, faHouse, faStore, faTruck } from '@fortawesome/free-solid-svg-icons'
      ...
      <div className={styles.group_primary}>
        ...
        <div 
          className={`${styles.nav_item} 
                      ${curr === adminHeroDiv.home ? styles.nav_item_focus : '' }`
                    }
        ...
        <div 
          className={`${styles.nav_item} 
          ${curr === adminHeroDiv.store ? styles.nav_item_focus : '' }`
                    }
        ...
        <div 
          className={`${styles.nav_item} 
          ${curr === adminHeroDiv.allProduct || curr === adminHeroDiv.addProduct ? styles.nav_item_focus : '' }`
                    }
